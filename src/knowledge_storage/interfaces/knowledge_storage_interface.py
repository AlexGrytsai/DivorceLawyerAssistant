...
class KnowledgeStorageInterface(ABC):
    ...
    This interface defines the contract for implementing knowledge storage systems,
    which serve as top-level containers for organizing corporate knowledge.
    ...
    async def list_storages(
        self, is_detail: bool = False, pagination: Optional[PaginationParams] = None
    ) -> Union[List[Union[KnowledgeSchema, KnowledgeDetailSchema]], PaginatedResponse]:
    ...
    async def set_storage_permission(
        ...
        """Set permission level for a user on a storage.
